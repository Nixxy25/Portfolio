...
const Skills = () => {
  return (
    ...
    <Element name="Skills" className="relative flex flex-col px-24 py-16 h-full max-sm:px-8 max-lg:px-12 ">
        ...
        <div className="text-center flex  justify-center pb-16" data-aos="fade-up">
            <p className=" border-l-4 px-4 py-2 border-[#219ebc] bg-[#219dbc70] text-2xl">Skills & Tools</p>
        </div>
        <div className="flex gap-12 items-center pb-8  max-lg:flex-col " data-aos="fade-up">
            <div className="flex flex-col justify-center items-center text-center shadow-n gap-6 rounded-md py-8 px-4 max-sm:w-full max-lg:w-3/4 h-full">
                <div className="flex justify-center hvr-float">
