                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex gap-3 items-center">
                                {items.skills.map((skill, skillIndex) => (
                                    <div key={skillIndex} className="px-2 py-1 border border-gray-400 rounded-md text-sm">
                                        {skill}
                                    </div>
                                ))}
                            </div>
